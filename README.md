...
**theoretical knowledge of RNA-seq analysis** 
...
RNA is less stable.
So during library preparation, RNA is converted into **complementary DNA (cDNA)**, because DNA is more stable and suitable for sequencing.
...
# Easy one-line definition for study or interview
...
**(1)** RNA-seq analysis theory in **exam style notes**, or
**(2)** a **step-by-step practical pipeline with tools names**.
